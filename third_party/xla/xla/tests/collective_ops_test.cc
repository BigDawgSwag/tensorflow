...
XLA_TEST_F(CollectiveOpsTest, AllGather_4BitInt) {
...
XLA_TEST_F(CollectiveOpsTest, AllToAll_4BitInt) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
    id32 = u32[] replica-id()
...
XLA_TEST_F(CollectiveOpsTest, CollectivePermute_4BitInt) {
...
XLA_TEST_F(CollectiveOpsTest, AllReduce_4BitInt) {
...
XLA_TEST_F(CollectiveOpsTest, ReduceScatter_4BitInt) {
  const char* const kModuleStr = R"(
  HloModule test
